					...
					<div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select name="method" class="form-control">
                                <option value="1" <?php if ($row['method'] == 1) echo 'selected';?>><?php echo ('Efectivo');?></option>
                                <option value="2" <?php if ($row['method'] == 2) echo 'selected';?>><?php echo ('Cheque');?></option>
                                <option value="3" <?php if ($row['method'] == 3) echo 'selected';?>><?php echo ('Tarjeta de Credito/Debito');?></option>
                            </select>
                        </div>
                    </div>
