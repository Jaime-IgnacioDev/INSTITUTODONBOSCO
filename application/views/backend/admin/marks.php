                	...
                	<tr>
                        ...
                        <td>
                        	<select name="class_id" class="form-control"  onchange="show_subjects(this.value)"  style="float:left;">
                                <option value=""><?php echo ('Selecciona una Clase');?></option>
                                <?php 
                        ...
                        <td>
							...
							<?php 
                                ...
                                <select name="<?php if($class_id == $row['class_id'])echo 'subject_id';else echo 'temp';?>" 
                                    ...
                                    <option value="">Asignatura de la clase <?php echo $row['name'];?></option>
                        ...
                        <td>
                    		...
                    		<input type="submit" value="<?php echo ('Administar Notas');?>" class="btn btn-info" />
                        </td>
                	</tr>
                </table>
                </form>
