                        ...
                        <select name="student_id" class="form-control" style="width:400px;" >
                            ...
                            ?>
                                <option value="<?php echo $row2['student_id'];?>"
                                    ...
                                    clase <?php echo $this->crud_model->get_class_name($row2['class_id']);?> -
                                    N° <?php echo $row2['roll'];?> -
                                    <?php echo $row2['name'];?>
                                </option>
                            <?php
                            endforeach;
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <select name="status" class="form-control">
                            ...
                            <option value="unpaid" <?php if($row['status']=='unpaid')echo 'selected';?>><?php echo ('Sin Pagar');?></option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
