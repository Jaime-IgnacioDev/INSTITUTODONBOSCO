		...
		<ul class="nav nav-tabs bordered">
			<li class="active">
            	<a href="#list" data-toggle="tab"><i class="entypo-menu"></i> 
					<?php echo ('Lista Rutina de Clases');?>
                    	</a></li>
			<li>
            	<a href="#add" data-toggle="tab"><i class="entypo-plus-circled"></i>
					<?php echo ('Agregar Rutina de Clases');?>
                    	</a></li>
		</ul>
    	<!------CONTROL TABS END------>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    <a data-toggle="collapse" data-parent="#accordion-test-2" href="#collapse<?php echo $row['class_id'];?>">
                                        <i class="entypo-rss"></i> Clase <?php echo $row['name'];?>
                                    </a>
                                    </h4>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <select name="class_id" class="form-control" style="width:100%;"
                                        ...
                                        <option value=""><?php echo ('Seleccionar Clase');?></option>
                                    	<?php 
										$classes = $this->db->get('class')->result_array();
										foreach($classes as $row):
										?>
