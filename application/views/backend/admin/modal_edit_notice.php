    ...
    <div class="box-content">
        ...
        <?php echo form_open(base_url(). 'index.php?admin/noticeboard/do_update/'.$row['notice_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
            <div class="padded">
                        ...
                        <div class="box closable-chat-box">
                            <div class="box-content padded">
                                    ...
                                    <textarea name="notice" id="ttt" rows="5" class="form-control"
                                    	placeholder="<?php echo ('Agregar Comunicado');?>"><?php echo $row['notice'];?></textarea>
                                    </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label"><?php echo ('Enviar SMS a todos');?></label>
                    <div class="col-sm-5">
                        ...
                        <span class="badge badge-primary">
                            <?php
                                ...
                                if ($active_sms_service == '' || $active_sms_service == 'disabled')
                                    echo ('Servicio SMS no esta activado');
                            ?>
                        </span>
                    </div>
                </div>
            ...
            <div class="form-group">
              <div class="col-sm-offset-3 col-sm-5">
                  <button type="submit" class="btn btn-info"><?php echo ('Editar Comunicado');?></button>
              </div>
            </div>
        </form>
        <?php endforeach;?>
