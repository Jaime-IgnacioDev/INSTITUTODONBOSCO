		...
		<ul class="nav nav-tabs bordered">
			<li class="active">
            	<a href="#list" data-toggle="tab"><i class="entypo-menu"></i> 
					<?php echo ('Sesión Académica');?>
                    	</a></li>
			<li>
            	<a href="#add" data-toggle="tab"><i class="entypo-plus-circled"></i>
					<?php echo ('Añadir Sesión');?>
                    	</a></li>
		</ul>
    	<!------CONTROL TABS END------>
                ...
                <table class="table table-bordered datatable table-hover table-striped" id="table_export">
                	<thead>
                		<tr>
                    		...
                    		<th><div><?php echo ('Esta Vigente?');?></div></th>
                    		<th><div><?php echo ('Fecha de Inicio');?></div></th>
                            <th><div><?php echo ('Fecha de Termino');?></div></th>
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td><?php echo ($row['is_open'] == '1' ? "Si" : "No");?></td>
                	...
                	<?php echo form_open(base_url() . 'index.php?admin/acd_session/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                        <div class="padded">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo ('A partir de');?></label>
                                <div class="col-sm-5">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo ('Esta Vigente?');?></label>
                                <div class="col-sm-5">
                        ...
                        <div class="form-group">
                              <div class="col-sm-offset-3 col-sm-5">
                                  <button type="submit" class="btn btn-info"><?php echo ('Agregar Sesión');?></button>
                              </div>
							</div>
                    </form>                
                </div>                
