	...
	<div class="col-md-12">
      ...
      <li class="active">
            	<a href="#list" data-toggle="tab"><i class="entypo-menu"></i> 
					<?php echo ('Lista de solicitudes de estudiantes');?>
                    	</a></li>
        
        	<li>
            	<a href="#add" data-toggle="tab"><i class="entypo-plus-circled"></i>
					<?php echo ('Agregar solicitud de estudiante');?>
                    	</a></li>
            ...
            <div class="tab-pane box active" id="list">
                ...
                <table class="table table-bordered table-hover table-striped datatable" id="table_export">
                	<thead>
                		<tr>
                    		<th><div>#</div></th>
                             <th width="80"><div><?php echo ('Fotografía');?></div></th>
                    		<th><div><?php echo ('Nombre Completo');?></div></th>
                    		<th><div><?php echo ('Correo Electrónico');?></div></th>
                            <th><div><?php echo ('Contacto');?></div></th>
                    		<th><div><?php echo ('Estado de Pago');?></div></th>
                            <th><div><?php echo ('Fecha de Aplicación');?></div></th>
