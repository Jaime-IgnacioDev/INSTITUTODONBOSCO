    ...
    <ul id="main-menu" class="">
            ...
            <ul>
                <li class="<?php if ($page_name == 'class') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/classes">
                        <span><i class="entypo-dot"></i> <?php echo ('Administrar Clases'); ?></span>
                    </a>
                </li>
                <li class="<?php if ($page_name == 'section') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/section">
                        <span><i class="entypo-dot"></i> <?php echo ('Administrar Secciones'); ?></span>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="<?php if ($page_name == 'subject') echo 'opened active'; ?> ">
            <a href="#">
                ...
                <span><?php echo ('Asignaturas'); ?></span>
            </a>
            <ul>
                <?php
        ...
        ?> ">
            ...
            <ul>
                <!-- STUDENT ADMISSION -->
                 ...
                 <li class="<?php if ($page_name == 'acd_session') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/acd_session">
                        <span><i class="entypo-dot"></i> <?php echo ('Sesión Academica'); ?></span>
                    </a>
                </li>
                ...
                <li class="<?php if ($page_name == 'student_information') echo 'opened active'; ?> ">
                    <a href="#">
                        <span><i class="entypo-dot"></i> <?php echo ('Información del Estudiante'); ?></span>
                    </a>
                    <ul>
                        <?php
                        $classes = $this->db->get('class')->result_array();
                ...
                <li class="<?php if ($page_name == 'student_marksheet') echo 'opened active'; ?> ">
                    <a href="#">
                        <span><i class="entypo-dot"></i> <?php echo ('Hola de Calificaciones'); ?></span>
                    </a>
                    <ul>
                        <?php
                        $classes = $this->db->get('class')->result_array();
        ...
        <li class="<?php if ($page_name == 'teacher') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?admin/teacher">
                ...
                <span><?php echo ('Sección Profesores'); ?></span>
            </a>
        </li>
        ...
        ?> ">
            <a href="#">
                ...
                <span><?php echo ('Sección de Evaluaciones'); ?></span>
            </a>
            <ul>
        ...
        <li class="<?php if ($page_name == 'invoice') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?admin/invoice">
                ...
                <span><?php echo ('Pago y Factura'); ?></span>
            </a>
        </li>
        ...
        ?> ">
            <a href="#">
                ...
                <span><?php echo ('Sección de Contabilidad'); ?></span>
            </a>
            <ul>
                <li class="<?php if ($page_name == 'income') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/income">
                        <span><i class="entypo-dot"></i> <?php echo ('Ingresos'); ?></span>
                    </a>
                </li>
                ...
                <li class="<?php if ($page_name == 'expense_category') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/expense_category">
                        <span><i class="entypo-dot"></i> <?php echo ('Categoria de Gastos'); ?></span>
                    </a>
                </li>
            </ul>
        </li>
            ...
            <ul>
                <li class="<?php if ($page_name == 'system_settings') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/system_settings">
                        <span><i class="entypo-dot"></i> <?php echo ('Configuración General'); ?></span>
                    </a>
                </li>
                <li class="<?php if ($page_name == 'sms_settings') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/sms_settings">
                        <span><i class="entypo-dot"></i> <?php echo ('Configuración SMS'); ?></span>
                    </a>
