		...
		<ul class="nav nav-tabs bordered">
			<li class="active">
            	<a href="#list" data-toggle="tab"><i class="entypo-menu"></i> 
					<?php echo ('Lista de Cursos');?>
                    	</a></li>
			<li>
            	<a href="#add" data-toggle="tab"><i class="entypo-plus-circled"></i>
					<?php echo ('Agregar Curso');?>
                    	</a></li>
		</ul>
    	<!------CONTROL TABS END------>
            ...
            <div class="tab-pane box active" id="list">
                ...
                <table class="table table-bordered table-hover table-striped datatable" id="table_export">
                	<thead>
                		<tr>
                    		<th><div>#</div></th>
                    		<th><div><?php echo ('Nombre del Curso');?></div></th>
                    		<th><div><?php echo ('Numero');?></div></th>
                ...
                <div class="box-content">
                	<?php echo form_open(base_url() . 'index.php?admin/classes/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                        <div class="padded">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo ('Numero');?></label>
                                <div class="col-sm-5">
                        ...
                        <div class="form-group">
                              <div class="col-sm-offset-3 col-sm-5">
                                  <button type="submit" class="btn btn-info"><?php echo ('Agregar Curso');?></button>
                              </div>
							</div>
                    </form>                
                </div>                
