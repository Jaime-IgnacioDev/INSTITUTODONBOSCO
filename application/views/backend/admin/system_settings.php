            ...
            <div class="panel panel-primary" >
                ...
                <div class="panel-body">
                  ...
                  <div class="form-group">
                      <label  class="col-sm-3 control-label"><?php echo ('Nombre Institución');?></label>
                      <div class="col-sm-9">
                  ...
                  <div class="form-group">
                      <label  class="col-sm-3 control-label"><?php echo ('Telefono');?></label>
                      <div class="col-sm-9">
                  ...
                  <div class="form-group">
                      <label  class="col-sm-3 control-label"><?php echo ('Alinea texto hacia');?></label>
                      <div class="col-sm-9">
                          <select name="text_align" class="form-control">
                          	  <?php $text_align	=	$this->db->get_where('settings' , array('type'=>'text_align'))->row()->description;?>
                              <option value="left-to-right" <?php if ($text_align == 'left-to-right')echo 'selected';?>> Izquiera a Derecha</option>
      ...
      ?>
        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-primary" >
                ...
                <div class="panel-heading">
                    <div class="panel-title">
                        <?php echo ('Configuración de Tema');?>
                    </div>
                </div>
                ...
                <center>
                  <div class="label label-primary" style="font-size: 12px;">
                    <i class="entypo-check"></i> <?php echo ('Selecciona un Tema para Hacer los cambios');?>
                  </div>
                </center>
                </div>
