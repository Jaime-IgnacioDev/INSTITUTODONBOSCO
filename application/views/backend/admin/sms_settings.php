...
<div class="row">
	<div class="col-md-12">
		...
		<div class="tabs-vertical-env">
			...
			<li class="active"><a href="#b-profile" data-toggle="tab">Selecciona un Servicio de SMS</a></li>
				<li>
					<a href="#v-home" data-toggle="tab">
						Clickatell Configuración
						<?php if ($active_sms_service == 'clickatell'):?>  
							<span class="badge badge-success"><?php echo ('Activo');?></span>
						<?php endif;?>
					</a>
				</li>
				<li>
