    	...
    	<!------CONTROL TABS END------>
            ...
            <div class="tab-pane  <?php if(!isset($edit_data) && !isset($personal_profile) && !isset($academic_result) )echo 'active';?>" id="list">
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="table table-bordered table-hover table-striped">
                	<tr>
                        <td><?php echo ('Selecciona un Examen');?></td>
                        <td><?php echo ('Selecciona una Clase');?></td>
                        <td><?php echo ('Selecciona una Asignatura');?></td>
                        <td>&nbsp;</td>
                	</tr>
                	<tr>
                        <td>
                        	<select name="exam_id" class="form-control"  style="float:left;">
                                <option value=""><?php echo ('Selecciona un Examen');?></option>
                                <?php 
                                ...
                                ?>
                                    <option value="<?php echo $row['exam_id'];?>"
                                        <?php if($exam_id == $row['exam_id'])echo 'selected';?>>
                                            <?php echo ('Clase');?> <?php echo $row['name'];?></option>
                                <?php
                                endforeach;
                                ?>
                            </select>
                                ...
                                ?>
                                    <option value="<?php echo $row['class_id'];?>"
                                        <?php if($class_id == $row['class_id'])echo 'selected';?>>
                                            Clase <?php echo $row['name'];?></option>
                                <?php
                                endforeach;
                                ?>
                            </select>
                        ...
                        <td>
							...
							<?php 
                                ...
                                <select name="<?php if($class_id == $row['class_id'])echo 'subject_id';else echo 'temp';?>" 
                                    ...
                                    <option value="">Asignatura de Clase <?php echo $row['name'];?></option>
                        ...
                        <td>
                    		...
                    		<input type="submit" value="<?php echo ('Administrar Notas');?>" class="btn btn-info" />
                        </td>
                	</tr>
                </table>
                </form>
