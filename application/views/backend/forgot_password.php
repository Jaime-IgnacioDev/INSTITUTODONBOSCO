        ...
        <div class="login-container">
            ...
            <div class="login-header login-caret">
                ...
                <div class="login-content" style="width:100%;">
                    ...
                    <p class="description">Ingresa tu correo para recuperar tu contraseña.</p>
            ...
            <div class="login-form">
                ...
                <div class="login-content">
                    ...
                    <div class="form-login-error">
                        <h3>Correo Invalido</h3>
                        <p>Porfavor ingrese un correo valido!</p>
                    </div>
                    <form method="post" role="form" id="form_forgot_password">

                        <div class="form-forgotpassword-success">
                            <i class="entypo-check"></i>
                            <h3>Se ha enviado el correo electrónico de restablecimiento</h3>
                            <p>¡Revise su bandeja de entrada de correo electrónico, se enviaron instrucciones para restablecer la contraseña!</p>
                        </div>
