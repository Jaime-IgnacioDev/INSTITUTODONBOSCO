	...
	<table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-hover table-striped">
    	<thead>
        	<tr>
            	<th><?php echo ('Seleccionar Día');?></th>
            	<th><?php echo ('Seleccionar Mes');?></th>
            	<th><?php echo ('Seleccionar Año');?></th>
            	<th><?php echo ('Seleccionar Clase');?></th>
		...
		<tbody>
        	<form method="post" action="<?php echo base_url();?>index.php?teacher/attendance_selector" class="form">
            	<tr class="gradeA">
                    ...
                    <td align="center"><input type="submit" value="<?php echo ('Administrar Asistencia');?>" class="btn btn-info"/></td>
                </tr>
            </form>
		</tbody>
	</table>
    ...
    <div class="row">
        <div class="col-sm-offset-4 col-sm-4">
            ...
            <div class="tile-stats tile-white-gray">
                ...
                <h3>Asistencia de Clase <?php echo ($class_id);?></h3>
